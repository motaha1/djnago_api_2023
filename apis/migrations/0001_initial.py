# Generated by Django 3.0.3 on 2022-11-29 12:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iiiii', models.CharField(blank=True, max_length=555, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc', models.ImageField(blank=True, null=True, upload_to='nurse_doc/%y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stars', models.IntegerField(default=1, null=True, validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('nurse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.Nurse')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.Patient')),
            ],
            options={
